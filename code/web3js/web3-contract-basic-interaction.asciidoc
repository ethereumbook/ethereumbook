...
The most remarkable thing about this script is that you don't need a local node running and sync because it use the https://infura.io[Infura services].

Anyway, I could adapt this script to be used with a local running node if is interesting.
