...
Wallets are the foundation of any user-facing blockchain application. They allow users to manage collections of keys and addresses. Wallets also allow users to demonstrate their ownership of ether, and authorize transactions, by applying digital signatures, as we will see in https://github.com/ethereumbook/ethereumbook/blob/develop/06transactions.asciidoc[tx_chapter].(((range="endofrange", startref="ix_05wallets-asciidoc0")))
