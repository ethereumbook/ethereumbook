...
[start=7]
1. The first parameter to the PBKDF2 key-stretching function is the _mnemonic_ produced in step 6.
2. The second parameter to the PBKDF2 key-stretching function is a _salt_. The salt is composed of the string constant +"mnemonic"+ concatenated with an optional user-supplied passphrase.
