...
----
The above Vyper syntax example shows the correct ordering of functions and variables in a Vyper smart contract. Note how the variable _theBool_ and the function _topFunction_ are declared before they are assigned and called respectively. If _theBool_ was declared below _topFunction_ or if _topFunction_ was declared below _lowerFunction_ this contract would not compile.
