...
This section is added to be used as a reference for those considering moving to development with Vyper.
Here are the main examples of what Vyper does NOT include, and a justification for each:
