...
Browser wallets are where your web browser has an Ethereum wallet running as a page or plugin. Ethereum browsers, in contrast, are where a browser is built in to an Ethereum client, allowing you to use a wallet and browse DApps inside a fully integrated user interface.

The most prominent example of an Ethereum browser is the official Ethereum browser, Mist.
