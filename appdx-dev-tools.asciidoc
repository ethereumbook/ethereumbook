...
Let's copy the _Faucet.sol_ contract (from https://github.com/ethereumbook/ethereumbook/blob/develop/code/Solidity/Faucet.sol[solidity_faucet_example]) into the _contracts_ subdirectory, so that the project directory looks like this:
