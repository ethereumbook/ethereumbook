...
Homestead:: The current (at the time of writing this book) stage of Ethereum, launched in March 2016

Metropolis:: The third stage of Ethereum, originally planned for 2017, but delayed until mid-2018.

Serenity:: The fourth and final stage of Ethereum. Serenity does not yet have a planned release date.

We are on the cusp of _Metropolis_, which is planned in two sub-release hard forks (see <<hard_fork>>) codenamed _Byzantium_ and _Constantinople_, anticipated 2018. Metropolis introduces some major changes to Ethereum, including a transition to a hybrid Proof-of-Work/Proof-of-Stake consensus algorithm (see <<consensus>>).
