...
The birth of Ethereum was the launch of the first stage, named "Frontier". Ethereum's development is planned over four distinct stages, with major changes occurring in each new stage. The four stages are:
...
Metropolis:: The third stage of Ethereum, current at the time of writing this book, launched in October 2017.

Serenity:: The fourth and final stage of Ethereum. Serenity does not yet have a planned release date.

We are currently in the _Metropolis_ stage, which was planned as two sub-release hard forks (see <<hard_fork>>) codenamed _Byzantium_ and _Constantinople_. Byzantium went into effect in October 2017 and Constantinople is anticipated by mid-2018. Constantinople is expected to introduce some major changes to Ethereum, including a transition to a hybrid Proof-of-Work/Proof-of-Stake consensus algorithm (see <<consensus>>).
