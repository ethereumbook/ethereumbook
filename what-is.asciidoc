...
We are currently in the _Metropolis_ stage, which was planned as two sub-release hard forks (see <<future_hard_fork>>) codenamed _Byzantium_ and _Constantinople_. Byzantium went into effect in October 2017 and Constantinople is anticipated in 2019.
...
Constantinople:: The second part of the Metropolis stage, planned for mid-2018 but since delayed with no set release date.
...
////
TODO - commented out this paragraph, as it doesn't add to the discussion. if you want it in, just delete the comment.
