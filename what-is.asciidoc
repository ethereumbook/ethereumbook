...
Ethereum is a globally decentralized computing platform that executes programs called _smart contracts_. It uses a blockchain to synchronize and store the system _state_ along with a crypto-currency called _ether_ to meter and constrain execution resource cost.
