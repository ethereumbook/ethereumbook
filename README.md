...
Mastering Ethereum is a book for developers, that offers a complete guide to the operations and use of the Ethereum, Ethereum Classic, RootStock (RSK) and other compatible EVM-based open blockchains.
