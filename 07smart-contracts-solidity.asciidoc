...
The +delegatecall+ method should be used with great caution. It can have some unexpected effects, especially if the contract you call was not designed as a library.
...
FaucetContract.web3.eth.getGasPrice(function(error, result) {
    ...
    FaucetContract.deployed().then(function(FaucetContractInstance) {
		...
		// estimation for this particular function
