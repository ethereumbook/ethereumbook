...
Address:: A 20-byte Ethereum address. The +address+ object has many helpful member functions, the main ones being pass:[<span class="keep-together"><code>balance</code></span>] (returns the account balance) and pass:[<span class="keep-together"><code>transfer</code></span>] (transfers ether to the account). 
