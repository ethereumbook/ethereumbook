...
For more details, see https://github.com/ethereum/EIPs/blob/master/EIPS/eip-155.md[the EIP-155 specification].(((range="endofrange", startref="ix_06transactions-asciidoc15")))(((range="endofrange", startref="ix_06transactions-asciidoc14")))
