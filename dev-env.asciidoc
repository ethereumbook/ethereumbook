...
----
Don't start running +geth+ yet, because it will start synchronizing the blockchain "the slow way" and that will take far too long (weeks). The next section explains the challenge with the initial synchronization of Ethereum's blockchain.
