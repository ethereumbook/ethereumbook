...
First, let's create and initialize a truffle project. Run these four commands and accept the default answers to https://github.com/ethereumbook/ethereumbook/blob/first_edition/code/Faucet.sol any questions:
