...
Tokens are abstractions, that represent something. That something can be intangible, such as a digital resource (ether, the ability to buy gas), a voting share for the Tesla corporation, a certificate of academic achievement.
