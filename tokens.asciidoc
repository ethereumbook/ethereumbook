...
----
truffle(ganache)> METoken.deployed().then(function(instance){ return instance.totalSupply();})
...
----
truffle(ganache)> METoken.deployed().then(function(instance){ instance.balanceOf(accounts[0]).then(function(result){console.log(result);});})
undefined
BigNumber { s: 1, e: 9, c: [ 2100000000 ] }
----
...
----
truffle(ganache)> METoken.deployed().then(function(instance){ instance.transfer(accounts[1], 100000);})
undefined
truffle(ganache)>
undefined
truffle(ganache)> METoken.deployed().then(function(instance){ instance.balanceOf(accounts[0]).then(function(result){console.log(result);});})
...
undefined
truffle(ganache)> METoken.deployed().then(function(instance){ instance.balanceOf(accounts[1]).then(function(result){console.log(result);});})
undefined
