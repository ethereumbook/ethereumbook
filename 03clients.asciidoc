...
https://metamask.io/[MetaMask], ((("MetaMask","as browser wallet")))introduced in <<02intro.asciidoc#choosing-an-ethereum-wallet, [intro_chapter]>>, is a versatile browser-based wallet, RPC client, and basic contract explorer. It is available on Chrome, Firefox, Opera, and Brave Browser.
