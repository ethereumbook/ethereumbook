...
((("Yellow Paper specification")))Ethereum is defined by a formal specification called the "Yellow Paper" (see link:01what-is.asciidoc#further-reading[<<references>>]).
