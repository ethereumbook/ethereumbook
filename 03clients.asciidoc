...
((("Yellow Paper specification")))Ethereum is defined by a formal specification called the "Yellow Paper" (see https://github.com/ethereumbook/ethereumbook/blob/develop/01what-is.asciidoc#further-reading[references]).
...
https://metamask.io/[MetaMask], ((("MetaMask","as browser wallet")))introduced in https://github.com/ethereumbook/ethereumbook/blob/develop/02intro.asciidoc#getting-started-with-metamask[intro_chapter], is a versatile browser-based wallet, RPC client, and basic contract explorer. It is available on Chrome, Firefox, Opera, and Brave Browser.
