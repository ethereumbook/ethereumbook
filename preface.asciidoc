...
As with, I suspect, a great many thinks, this book came about as the merging of several different threads stories and ideas. For my part I had been wishing to write a book that expanded on the Yellow Paper (my technical description of the Ethereum protocol) for some time, primarily to open it up to a wider audience than the original greek-letter-infused document could posibly allow.

Plans were underway---publishers had been found---when I got talking to Andreas. I knew Andreas from the very beginning of my tenure with Ethereum. Having coded the first few Ethereum proofs of concept, Andreas was a notable personality in the space who was interested in learning more about what we were doing. He downloaded and built my code to see, I presume, what the fuss was about first hand. We chatted a little over Skype and I was happy to find that he was generally supportive of what we were experimenting with.

Fast-forward two years and it's the 29th of May, 2016. Andreas had mentioned he'd be interesting in working on a following book to Mastering Bitcoin that covered Ethereum and finally, we were both, oddly enough, in the same city at the same time. We met up for a coffee to chat about working on a project together - a merging of our ideas, so to speak. The upshot of the meeting was to agree to pursue it. With both of us being devotees of the open-source paradigm we were both committed to this being something of a community-effort and released under a creative commons license. Thankfully our publishers, O'Reilly, were happy to agree.

With O'Reilly on-board with our proposal, we pushed forward with content. Co-authoring content that needs to be coherent is not necessarily an easy task. In our case, the workflow was essentially involved Andreas writing an initial draft of each chapter and me following up, injecting or mending technical content as needed. I think things worked reasonably well, but we'll let you be the ultimate judge...
...
TODO This section somewhat repeats the last paragraph of “Code examples”. I suggest moving it after that section and deleting the sentence “For example, the private keys…” in “Code examples”.
...
TODO Add country code for US under “How to contact us”? Could simply repeat the number but with “001” prefix.
...
link:$$https://riot.im/app/#/room/#polkadot-watercooler:matrix.org$$[]
...
TODO it would aid legibility (grouping source with license) if there was either less space before each license or more space after each (or both!).
