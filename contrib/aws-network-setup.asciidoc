...
[source,bash]
----
geth --bootnodes --datadir "eth-priv" --networkid "15" --maxpeers 3 --port 30303
----
...
[source,bash]
----
geth --datadir "eth-priv" --networkid 15 --maxpeers 3  --port 30333 console // <1>
admin.peers  // <2>
----
...
10. Finally, log on to Ethereum-Standalone node again and check list of all connected peers. See <<_code_list_of_peers>>.
