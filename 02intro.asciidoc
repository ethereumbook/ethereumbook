...
We will do a lot more smart contract programming in https://github.com/ethereumbook/ethereumbook/blob/develop/07smart-contracts-solidity.asciidoc#introduction-to-ethereum-high-level-languages[smart_contracts_chapter] and learn about best practices and security considerations in https://github.com/ethereumbook/ethereumbook/blob/develop/09smart-contracts-security.asciidoc[smart_contract_security].(((range="endofrange", startref="ix_02intro-asciidoc0")))
