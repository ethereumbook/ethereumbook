...
internal transaction (also "message")::A Smart Contract is an autonomous computer program that can be triggered under certain conditions to execute a deterministic set of instructions without any possible third party interference. The concept was introduced by Nick Szabo in 1994, presenting the cryptographic equivalent of a vending machine.
