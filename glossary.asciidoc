...
Truffle::
  One of the most commonly used Ethereum Development Framework. It is composed of several NodeJS packages and can be installed using Node Package Manager (NPM).
