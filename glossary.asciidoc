...
DAO::
  Decentralised Autonomous Organization. A contract named "The DAO" was launched on 30th April 2016, which was then hacked in June 2016. DAO also refers to the hard fork at block #1,192,000 that reversed the hacked DAO contract and caused Ethereum and Ethereum Classic to split into two competing systems.
