...
wallet::
    Software that holds all your public and secret keys. Used as the interface to access and control your blockchain Ethereum accounts and interact with Smart Contracts.
