...
For example, the Ethereum Foundation donation address is +0xfB6916095ca1df60b&thinsp;B79Ce92cE3Ea74c37c5d359+; in a wallet that supports ENS, it's simply +ethereum.eth+.
