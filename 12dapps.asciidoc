...
For example, the Ethereum Foundation donation address is +0xfB6916095&thinsp;ca1df60bB79Ce92cE3Ea74c37c5d359+; in a wallet that supports ENS, it's simply +ethereum.eth+.
