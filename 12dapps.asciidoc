...
((("ENS (Ethereum Name Service)","history of")))Name registration was the first non-currency application of blockchains, pioneered by Namecoin. The Ethereum https://github.com/ethereum/wiki/wiki/White-Paper[White Paper] gave a two-line Namecoin-like registration system as one of its example applications.

Early releases of Geth and the C++ Ethereum client had a built-in +namereg+ contract (not used any more), and many proposals and ERCs for name services were made, but it was only when ((("Johnson, Nick")))Nick Johnson started working for the Ethereum Foundation in 2016 and took the project under his wing that serious work on a registrar started.
