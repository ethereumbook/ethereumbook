...
Let's start by looking at +DeedRepository+, shown in <<deed_repository_code>>. This contract is an ERC721-compatible non-fungible token (see xref:10tokens.asciidoc#erc721[erc721]).
