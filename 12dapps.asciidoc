...
((("Swarm","installing and initializing")))To get started, you need to install Swarm and initialize your Swarm node. Swarm is part of the Ethereum Foundation's Go-Ethereum suite of tools. Refer to the instructions for installing Go-Ethereum in the https://geth.ethereum.org/docs/install-and-build/installing-geth[Geth documentation], or to install a Swarm binary release, follow the instructions in the https://mainframe-swarm-guide.readthedocs.io[Swarm documentation].
