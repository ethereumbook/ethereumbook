...
((("ENS (Ethereum Name Service)","history of")))Name registration was the first noncurrency application of blockchains, pioneered by Namecoin. The Ethereum https://github.com/ethereum/wiki/wiki/White-Paper[White Paper] gave a two-line Namecoin-like registration system as one of its example applications.
