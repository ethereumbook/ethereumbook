...
[TIP]
====
2^256^&#x2014;the size of Ethereum's private key space&#x2014;is an unfathomably large number. It is approximately 10^77^ in decimal; that is, a number with 77 digits. For comparison, the Earth has about 10^50^ atoms. Thus, there are enough private keys to give every atom on Earth an Ethereum account, with enough left over for 10^27 more Earths. (And 10^27^, by the way, is more than the quantity of sand on this planet.) If you pick a private key randomly, there is no conceivable way anyone will ever guess it or pick it themselves.
====
