...
((("Serenity")))((("Ethereum 2.0")))Two hard forks, Berlin and London, have been announced already. The next stage, initially codenamed Serenity, will involve a profound reorganization of the infrastructure and take several years. Therefore, it is presented as the second version of Ethereum, "Ethereum 2.0".
