...
| https://github.com/ethereum/EIPs/issues/234[EIP-234]  | Add `blockHash` to JSON-RPC filter options    |  Micah Zoltu  | Interface       | Draft    | |
| https://github.com/ethereum/EIPs/pull/615[EIP-615]   | Subroutines and Static Jumps for the EVM | Greg Colvin             | Core       | Draft    | |
| https://github.com/ethereum/EIPs/pull/616[EIP-616]   | SIMD Operations for the EVM | Greg Colvin             | Core       | Draft    | |
| https://github.com/ethereum/EIPs/pull/681[EIP-681]   | ERC-681 URL Format for Transaction Requests | Daniel A. Nagy             | Interface       | Draft    | |
